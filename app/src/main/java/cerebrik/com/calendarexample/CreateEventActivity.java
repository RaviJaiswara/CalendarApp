...
import cerebrik.com.calendarexample.alarm.AlarmContract;
import cerebrik.com.calendarexample.alarm.AlarmModifier;
import cerebrik.com.calendarexample.data.Event;
import cerebrik.com.calendarexample.utils.ColorUtils;
...
public class CreateEventActivity extends AppCompatActivity {
    ...
    private void extractDataFromIntentAndInitialize() {
        ...
        if (mOriginalEvent == null) {
            ...
            mMessage = mOriginalEvent.getMessage();
    ...
    private void initializeUI() {
        ...
        mMessageView = findViewById(R.id.et_event_message);
        ...
        if (isViewMode) {
            ...
            mMessageView.setOnFocusChangeListener(new View.OnFocusChangeListener() {
                ...
                public void onFocusChange(View v, boolean hasFocus) {
                    setupEditMode();
                    mMessageView.setOnFocusChangeListener(null);
                }
            });
        } else {
            setupEditMode();
    ...
    private void save() {
        ...
        String rawMessage = mMessageView.getText().toString().trim();
        AlarmModifier alarmModifier = new AlarmModifier();
        int idBrod =
        alarmModifier.setAlarmOnTime(this, mCalendar.getTimeInMillis(), id);

        mOriginalEvent = new Event(
                id,
                rawTitle.isEmpty() ? null : rawTitle,
                rawMessage.isEmpty() ? null : rawMessage,
                mCalendar,
                mColor,
