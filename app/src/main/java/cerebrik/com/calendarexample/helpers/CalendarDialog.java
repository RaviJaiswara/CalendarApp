package cerebrik.com.calendarexample.helpers;
...
public class CalendarDialog {
    ...
    public void setEventList(List<Event> eventList) {
        saveEventListToShare(mContext, eventList);
        mEventList = eventList;
        mViewPagerAdapter.notifyDataSetChanged();
    }

    public static void saveEventListToShare(Context context, List<Event> eventList){
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context.getApplicationContext());
        SharedPreferences.Editor prefsEditor =sharedPreferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(eventList);
        prefsEditor.putString("eventList", json);
        prefsEditor.commit();
    }

    public static String getEventListFromShare(Context context) {

        SharedPreferences appSharedPrefs = PreferenceManager
                .getDefaultSharedPreferences(context.getApplicationContext());
        return appSharedPrefs.getString("eventList", null);
    }
    ...
    private class CalendarEventAdapter extends RecyclerView.Adapter<CalendarEventAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            String defaultMessage = holder.itemView.getContext().getString(R.string.event_default_message);
            String title = event.getTitle() == null ? defaultTitle : event.getTitle();
            String message = event.getMessage() == null ? defaultMessage : event.getMessage();

            holder.tvEventName.setText(title);
            holder.tvEventMessage.setText(message);
        ...
        class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            ViewHolder(View view) {
                ...
                tvEventMessage = view.findViewById(R.id.tv_calendar_event_message);
